...
const Coupons = (props) => {
  ...
  return (
    <div className="bg-gray-100 w-full h-full overflow-y-scroll scrollbar-hide p-6 pb-28">
              ...
              <div className="bg-custom-orange p-4 text-white">
                <div className="flex justify-between items-start gap-2">
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-bold truncate">{coupon.code}</h3>
                    <p className="text-xs opacity-90 mt-1 line-clamp-2">{coupon.description}</p>
                  </div>
                  <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold whitespace-nowrap ${
                    !coupon.isActive
                      ? 'bg-red-500'    // Inactive (highest priority)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {formData.code.length}/16 characters
                    </p>
                  </div>
